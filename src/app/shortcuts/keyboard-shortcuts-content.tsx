...
export default function KeyboardShortcutsContent() {
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="p-2 bg-slate-100 dark:bg-slate-800/30 rounded-lg">
            <Keyboard className="h-6 w-6 text-slate-600 dark:text-slate-400" />
          </div>
      ...
      {/* Tips */}
      <div className="bg-gradient-to-r from-slate-50 to-slate-100 dark:from-slate-800/20 dark:to-slate-700/20 rounded-xl p-4 mb-8 border border-slate-200 dark:border-slate-700">
        <div className="flex items-start gap-3">
          <Sparkles className="h-5 w-5 text-slate-500 mt-0.5" />
          <div>
            <p className="font-medium text-slate-900 dark:text-slate-100 mb-1">Quick Tips</p>
